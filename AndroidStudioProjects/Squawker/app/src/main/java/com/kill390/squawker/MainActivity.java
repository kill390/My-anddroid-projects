...
import com.kill390.squawker.following.FollowingPreferenceActivity;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (name != null && name.containsKey("test")){
            Log.i( "onCreate: ",name.getString("test"));
