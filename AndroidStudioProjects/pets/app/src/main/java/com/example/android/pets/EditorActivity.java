...
import com.example.android.pets.data.cotract;
import com.example.android.pets.data.petDbHelper;

import static com.example.android.pets.data.cotract.*;
import static com.example.android.pets.data.cotract.PetEntry.GENDER_FEMALE;
import static com.example.android.pets.data.cotract.PetEntry.GENDER_MALE;
import static com.example.android.pets.data.cotract.PetEntry.GENDER_UNKNOWN;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet() {
        ...
        String nameEdit = mNameEditText.getText().toString().trim();
        String breedText = mBreedEditText.getText().toString().trim();
        String weightText = mWeightEditText.getText().toString().trim();
        String genderText = mGenderSpinner.getSelectedItem().toString();
//        int weight = Integer.parseInt(weightText);
        if (uri == null && TextUtils.isEmpty(nameEdit) &&
        ...
        values.put(PetEntry.COLUMN_PET_NAME, nameEdit);
        values.put(PetEntry.COLUMN_PET_BREED, breedText);
        values.put(PetEntry.COLUMN_PET_GENDER, genderText);
