package com.kill390.xboxlive.ui.home;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        rewardedAd1 = createAndLoadRewardedAd("ca-app-pub-2000845409770635/1218084494");
...
//        SharedPreferences sharedPreferences = requireContext().getSharedPreferences("com.kill390.xboxlive.ui.home", Context.MODE_PRIVATE);
                ...
                new AlertDialog.Builder(requireContext()).setTitle("Invite a friend")
                        ...
                        .setPositiveButton("Share", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String shareBody = "https://play.google.com/store/apps/details?id=com.kill390.freenetflix" + "\nthis is your invite code: " + invitecode;
                        ...
                        .setNeutralButton("copy code", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {

                                ClipboardManager clipboard = (ClipboardManager) getActivity().getSystemService(Context.CLIPBOARD_SERVICE);
                                ClipData clip = ClipData.newPlainText("", invitecode);
                                clipboard.setPrimaryClip(clip);

                                Toast.makeText(getContext(), "Copied to clipboard done", Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View v) {
                try {
                    if (Settings.Global.getInt(requireActivity().getContentResolver(), Settings.Global.AUTO_TIME) == 1) {
                        ...
                        SharedPreferences sp = requireContext().getSharedPreferences("com.kill390.xboxlive.ui.home", Context.MODE_PRIVATE);
...
//
//                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.kill390.xboxlive"));
...
//        });
    ...
    public InterstitialAd createAd() {
        ...
        mInterstitialAd.setAdUnitId("ca-app-pub-2000845409770635/9503768629");
