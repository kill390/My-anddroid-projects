...
import com.kill390.freeprime.AccountsActivity;
...
public class NotificationService extends Service {
    ...
    public void onCreate() {
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "CHANNEL_ID")
                ...
                .setContentTitle("Free prime accounts")
                .setContentText(msg)
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.child("accounts").getValue() != null) {
                    if (!snapshot.child("accounts").child("email").getValue().toString().equals("null")) {
                        ...
                        SharedPreferences sp = getSharedPreferences("com.kill390.freeprime.services", Context.MODE_PRIVATE);
                        String email = sp.getString("email", "");

                        if (!email.equals(snapshot.child("accounts").child("email").getValue().toString())) {

                            SharedPreferences sp2 = getSharedPreferences("com.kill390.freeprime.services", Context.MODE_PRIVATE);
    ...
    public void onDestroy() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("com.kill390.freeprime", Context.MODE_PRIVATE);
